...
if( isset( $_POST['submit'] ) ){
	...
	$input = new EntryTranPaysleInput();/* @var $input EntryTranPaysleInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new EntryTranPaysle();/* @var $exec EntryTranPaysle */

	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output EntryTranPaysleOutput */
...
//EntryTranPaysle入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/EntryTranPaysle.php' );