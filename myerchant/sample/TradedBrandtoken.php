...
if( isset( $_POST['submit'] ) ){
	require_once( 'com/gmo_pg/client/input/TradedBrandtokenInput.php');
	require_once( 'com/gmo_pg/client/tran/TradedBrandtoken.php');

	//入力パラメータクラスをインスタンス化します
	$input = new TradedBrandtokenInput();/* @var $input TradedBrandtokenInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new TradedBrandtoken();/* @var $exec TradedBrandtoken */

	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output TradedBrandtokenOutput */
...
//TradedBrandtoken入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/TradedBrandtoken.php' );