<?php
require_once (BASEPATH.DIRECTORY_SEPARATOR.'src/com/gmo_pg/client/common/Cryptgram.php');
require_once (BASEPATH.DIRECTORY_SEPARATOR.'src/com/gmo_pg/client/common/GPayException.php');
require_once (BASEPATH.DIRECTORY_SEPARATOR.'src/com/gmo_pg/client/output/EntryTranOutput.php');
require_once (BASEPATH.DIRECTORY_SEPARATOR.'src/com/gmo_pg/client/tran/BaseTran.php');
/**
 * <b>取引登録　実行クラス</b>
 *
