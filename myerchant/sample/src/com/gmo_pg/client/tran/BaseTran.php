<?php
require_once BASEPATH.DIRECTORY_SEPARATOR.'src/com/gmo_pg/client/common/Gmopg_Log.php';
require_once BASEPATH.DIRECTORY_SEPARATOR.'src/com/gmo_pg/client/common/ParamParser.php';
require_once BASEPATH.DIRECTORY_SEPARATOR.'src/com/gmo_pg/client/common/IgnoreCaseMap.php';
require_once BASEPATH.DIRECTORY_SEPARATOR.'src/com/gmo_pg/client/common/GPayException.php';
require_once BASEPATH.DIRECTORY_SEPARATOR.'src/com/gmo_pg/client/common/ConnectUrlMap.php';
/**
 * @abstract
 * <b>API 基底クラス</b>
 *
