...
if( isset( $_POST['submit'] ) ){
	require_once( 'com/gmo_pg/client/input/PaysleCancelInput.php');
	require_once( 'com/gmo_pg/client/tran/PaysleCancel.php');

	//入力パラメータクラスをインスタンス化します
	$input = new PaysleCancelInput();/* @var $input PaysleCancelInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new PaysleCancel();/* @var $exec PaysleCancel */

	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output PaysleCancelOutput */
...
//PaysleCancel入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/PaysleCancel.php' );