...
if( isset( $_POST['submit'] ) ){
	...
	$input = new ExecTranAuInput();/* @var $input ExecTranAuInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new ExecTranAu();/* @var $exec ExecTranAu */

	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output ExecTranAuOutput */
...
//ExecTranAu入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/ExecTranAu.php' );