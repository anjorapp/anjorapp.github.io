...
if( isset( $_POST['submit'] ) ){
	require_once( 'com/gmo_pg/client/input/SearchPrecaInput.php');
	require_once( 'com/gmo_pg/client/tran/SearchPreca.php');

	//入力パラメータクラスをインスタンス化します
	$input = new SearchPrecaInput();/* @var $input SearchPrecaInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new SearchPreca();/* @var $exec SearchPreca */

	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output SearchPrecaOutput */
...
//SearchPreca入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/SearchPreca.php' );