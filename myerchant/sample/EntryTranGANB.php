...
if( isset( $_POST['submit'] ) ){
	...
	$input = new EntryTranGANBInput();/* @var $input EntryTranGANBInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new EntryTranGANB();/* @var $exec EntryTranGANB */

	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output EntryTranGANBOutput */
...
//EntryTranGANB入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/EntryTranGANB.php' );