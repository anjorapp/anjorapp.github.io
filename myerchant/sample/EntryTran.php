...
if( isset( $_POST['submit'] ) ){
	require_once( BASEPATH.DIRECTORY_SEPARATOR.'src/com/gmo_pg/client/input/EntryTranInput.php');
	require_once( BASEPATH.DIRECTORY_SEPARATOR.'src/com/gmo_pg/client/tran/EntryTran.php');
