...
if( isset( $_POST['submit'] ) ){
	...
	require_once( 'com/gmo_pg/client/input/EntryExecTranSbAcceptInput.php');
	require_once( 'com/gmo_pg/client/tran/EntryExecTranSbAccept.php');
	
	//入力パラメータクラスをインスタンス化します
	$input = new EntryExecTranSbAcceptInput();/* @var $input EntryExecTranSbAcceptInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new EntryExecTranSbAccept();/* @var $exec EntryExecTranSbAccept */
	
	//パラメータオブジェクトを引数に、実行メソッドを呼びます。
	//正常に終了した場合、結果オブジェクトが返るはずです。
	$output = $exe->exec( $input );/* @var $output EntryExecTranSbAcceptOutput */
...
//EntryExecTranSbAccept入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/EntryExecTranSbAccept.php' );