...
if( isset( $_POST['submit'] ) ){
	...
	$input = new EntryTranRecruitContinuanceInput();/* @var $input EntryTranRecruitContinuanceInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new EntryTranRecruitContinuance();/* @var $exec EntryTranRecruitContinuance */

	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output EntryTranRecruitContinuanceOutput */
...
//EntryTranRecruitContinuance入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/EntryTranRecruitContinuance.php' );