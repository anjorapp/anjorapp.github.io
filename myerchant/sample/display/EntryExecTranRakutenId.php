	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				...
				<td><input name="SubscriptionType" type="text" size="27" tabindex="29" /></td>
			</tr>
			<tr>
				<th scope="row">サブスクリプション名(SubscriptionName)</th>
				<td><input name="SubscriptionName" type="text" size="27" tabindex="30" /></td>
			</tr>
			<tr>
				<th scope="row">決済用サブスクリプションID(SettlementSubscriptionId)</th>
				<td><input name="SettlementSubscriptionId" type="text" size="27" tabindex="31" /></td>
			</tr>
