...
<head>
	...
	<title>[DocomoIncrease]-PGマルチペイメントサービス－モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>ドコモ払い決済増額/モジュールタイプ(PHP) 呼び出しサンプル</h1>
...
<div id="main">
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				<th scope="row">増加金額(IncreaseAmount)</th>
				<td><input name="IncreaseAmount" type="text" size="10" tabindex="11" class="num" /></td>
			</tr>
			<tr>
				<th scope="row">増加税送料(IncreaseTax)</th>
				<td><input name="IncreaseTax" type="text" size="10" tabindex="11" class="num" /></td>
			</tr>
			</tbody>
		</table>
	</form>
	...
	?>
		<table>
			...
			<tbody>
				...
				<tr>
					<th scope="row">増加金額(IncreaseAmount)</th>
					<td><?php echo $output->getIncreaseAmount() ?></td>
				</tr>
				<tr>
					<th scope="row">増額税送料(IncreaseTax)</th>
					<td><?php echo $output->getIncreaseTax() ?></td>
				</tr>
			</tbody>
		</table>
	<?php
