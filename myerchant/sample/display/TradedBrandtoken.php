...
<head>
	...
	<title>[TradedBrandtoken]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>ブランドトークン決済ブランドトークン登録／更新/モジュールタイプ(PHP) 呼び出しサンプル</h1>
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				...
				<td><input name="ShopID" type="text" size="27" tabindex="14" /></td>
			</tr>
			<tr>
				<th scope="row">ショップパスワード(ShopPass)</th>
				<td><input name="ShopPass" type="text" size="27" tabindex="15" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input name="DefaultFlag" type="text" size="27" tabindex="17" /></td>
			</tr>
			<tr>
