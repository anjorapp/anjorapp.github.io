...
<head>
	...
	<title>[ExecTranAuAccept]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>auかんたん決済支払い（利用承諾）決済実行/モジュールタイプ(PHP) 呼び出しサンプル</h1>
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				...
				<td><input name="Commodity" type="text" size="27" tabindex="24" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input name="PaymentTermSec" type="text" size="10" tabindex="26" class="num" /></td>
			</tr>
			<tr>
				<th scope="row">表示サービス名(ServiceName)</th>
				<td><input name="ServiceName" type="text" size="27" tabindex="27" /></td>
			</tr>
			<tr>
				<th scope="row">表示電話番号(ServiceTel)</th>
				<td><input name="ServiceTel" type="text" size="27" tabindex="28" /></td>
			</tr>
