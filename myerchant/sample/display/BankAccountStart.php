...
<head>
	...
	<title>[BankAccountStart]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>口振オンライン金融機関遷移/モジュールタイプ(PHP) 呼び出しサンプル</h1>
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				...
				<td><input name="TranID" type="text" size="27" tabindex="11" /></td>
			</tr>
			<tr>
