...
<head>
	...
	<title>[InquiryTransferGANB]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>GANB入金履歴参照/モジュールタイプ(PHP) 呼び出しサンプル</h1>
...
<div id="main">
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				<th scope="row">照会期間(開始日) (DateFrom)</th>
				<td><input name="DateFrom" type="text" size="10" tabindex="16" class="num" /></td>
			</tr>
			<tr>
				<th scope="row">照会期間(終了日) (DateTo)</th>
				<td><input name="DateTo" type="text" size="10" tabindex="17" class="num" /></td>
			</tr>
