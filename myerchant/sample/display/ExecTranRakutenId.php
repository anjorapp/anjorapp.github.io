...
<head>
	...
	<title>[ExecTranRakutenId]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>楽天ID決済実行/モジュールタイプ(PHP) 呼び出しサンプル</h1>
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				...
				<td><input name="ItemId" type="text" size="27" tabindex="19" /></td>
			</tr>
			<tr>
				<th scope="row">サブ商品ID(ItemSubId)</th>
				<td><input name="ItemSubId" type="text" size="27" tabindex="20" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input name="RetURL" type="text" size="27" tabindex="22" /></td>
			</tr>
			<tr>
				<th scope="row">処理NG時URL(ErrorRcvURL)</th>
				<td><input name="ErrorRcvURL" type="text" size="27" tabindex="23" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input name="MultiItem" type="text" size="27" tabindex="25" /></td>
			</tr>
			<tr>
				<th scope="row">サブスクリプションタイプ(SubscriptionType)</th>
				<td><input name="SubscriptionType" type="text" size="27" tabindex="26" /></td>
			</tr>
			<tr>
				<th scope="row">サブスクリプション名(SubscriptionName)</th>
				<td><input name="SubscriptionName" type="text" size="27" tabindex="27" /></td>
			</tr>
			<tr>
				<th scope="row">決済用サブスクリプションID(SettlementSubscriptionId)</th>
				<td><input name="SettlementSubscriptionId" type="text" size="27" tabindex="28" /></td>
			</tr>
	...
	?>
		<table>
			...
			<tbody>
				...
				<tr>
					<th scope="row">改ざんチェック文字列(CheckString)</th>
