...
<head>
	...
	<title>[ExecTranSbAccept]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>ソフトバンクまとめて支払い(Ｂ)(利用承諾)決済実行/モジュールタイプ(PHP) 呼び出しサンプル</h1>
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				...
				<td><input name="PaymentTermSec" type="text" size="10" tabindex="20" class="num" /></td>
			</tr>
			<tr>
