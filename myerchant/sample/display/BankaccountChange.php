...
<head>
	...
	<title>[BankaccountChange]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>口振セレクト請求情報変更/モジュールタイプ(PHP) 呼び出しサンプル</h1>
		...
		<table>
			...
			<tbody>
				...
				<tr>
					...
					<td><?php echo htmlspecialchars( mb_convert_encoding( $output->getRemarks() , PGCARD_SAMPLE_ENCODING , 'SJIS') ) ?></td>
				</tr>
