...
<div id="header">
	<h1>NET CASH登録・決済実行/モジュールタイプ(PHP) 呼び出しサンプル</h1>
...
<div id="main">
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				<th scope="row">リダイレクトURL(RetURL)</th>
				<td><input name="RetURL" type="text" size="27" tabindex="18" /></td>
			</tr>
			<tr>
			...
			<tr>
				<th scope="row">NET CASH決済方法(NetCashPayType)</th>
				<td><input name="NetCashPayType" type="text" size="27" tabindex="22" /></td>
			</tr>
