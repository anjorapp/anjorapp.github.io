...
<head>
	...
	<title>[CreatePreca]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>PGプリカPGプリカ発行/モジュールタイプ(PHP) 呼び出しサンプル</h1>
...
<div id="main">
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				<th scope="row">プリカ名称(PrecaName)</th>
				<td><input name="PrecaName" type="text" size="27" tabindex="15" /></td>
			</tr>
	...
	?>
		<table>
			...
			<tbody>
				...
				<tr>
					<th scope="row">プリカ認証番号(PrecaPass)</th>
					<td><?php echo $output->getPrecaPass() ?></td>
				</tr>
