...
<head>
	...
	<title>[DocomoAcceptUserEnd]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>ドコモ払い_随時決済利用承諾終了/モジュールタイプ(PHP) 呼び出しサンプル</h1>
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				...
				<td><input name="DocomoAcceptCode" type="text" size="27" tabindex="16" /></td>
			</tr>
