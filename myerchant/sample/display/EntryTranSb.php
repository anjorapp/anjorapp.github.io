...
<head>
	...
	<title>[EntryTranSb]-PGマルチペイメントサービス－モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>ソフトバンクまとめて支払い(Ｂ)取引登録/モジュールタイプ(PHP) 呼び出しサンプル</h1>
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				...
				<td><input name="PaymentType" type="text" size="10" tabindex="17" /></td>
			</tr>
			</tbody>
		</table>
	</form>
	...
	?>
		<table>
			...
			<tfoot>
				<tr>
					<td colspan="2">
						<a href="ExecTranSb.php?<?php echo 'AccessID=' . urlencode( $output->getAccessID()) . '&AccessPass=' . urlencode( $output->getAccessPass())  ?>" tabindex="30">
						引き続き決済実行(ExecTranSb)を行う</a>
					</td>
				</tr>
			</tfoot>
