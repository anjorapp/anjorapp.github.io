...
<head>
	...
	<title>[ExecTranPaysle]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>Paysle決済実行/モジュールタイプ(PHP) 呼び出しサンプル</h1>
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				...
				<td><input name="DisplayTermDay" type="text" size="27" tabindex="19" /></td>
			</tr>
			<tr>
				<th scope="row">支払期限日数(PaymentTermDay)</th>
				<td><input name="PaymentTermDay" type="text" size="27" tabindex="20" /></td>
			</tr>
			<tr>
				<th scope="row">購入者通知日数(NotifyTermDay)</th>
				<td><input name="NotifyTermDay" type="text" size="27" tabindex="21" /></td>
			</tr>
			<tr>
				<th scope="row">購入者氏名(CustomerName)</th>
				<td><input name="CustomerName" type="text" size="27" tabindex="22" /></td>
			</tr>
			<tr>
				<th scope="row">購入者携帯電話番号(CustomerTel)</th>
				<td><input name="CustomerTel" type="text" size="27" tabindex="23" /></td>
			</tr>
			<tr>
				<th scope="row">購入者管理ID(CustomerId)</th>
				<td><input name="CustomerId" type="text" size="27" tabindex="24" /></td>
			</tr>
			<tr>
				<th scope="row">請求書タイトル(InvoiceTitle)</th>
				<td><input name="InvoiceTitle" type="text" size="27" tabindex="25" /></td>
			</tr>
			<tr>
				<th scope="row">商品番号（明細）(ItemId)</th>
				<td><input name="ItemId" type="text" size="27" tabindex="26" /></td>
			</tr>
			<tr>
				<th scope="row">商品名（明細）(ItemName)</th>
				<td><input name="ItemName" type="text" size="27" tabindex="27" /></td>
			</tr>
			<tr>
				<th scope="row">複数商品(MultiItem)</th>
				<td><input name="MultiItem" type="text" size="27" tabindex="28" /></td>
			</tr>
			<tr>
				<th scope="row">数量（明細）(ItemNumbers)</th>
				<td><input name="ItemNumbers" type="text" size="10" tabindex="29" class="num" /></td>
			</tr>
			<tr>
				<th scope="row">単価（明細）(ItemFee)</th>
				<td><input name="ItemFee" type="text" size="10" tabindex="30" class="num" /></td>
			</tr>
			<tr>
				<th scope="row">消費税額(PaysleTax)</th>
				<td><input name="PaysleTax" type="text" size="10" tabindex="31" class="num" /></td>
			</tr>
			<tr>
				<th scope="row">送料(PaysleShippingFee)</th>
				<td><input name="PaysleShippingFee" type="text" size="10" tabindex="32" class="num" /></td>
			</tr>
			<tr>
				<th scope="row">機種名(DeviceName)</th>
				<td><input name="DeviceName" type="text" size="27" tabindex="33" /></td>
			</tr>
			<tr>
				<th scope="row">OSバージョン(OsVersion)</th>
				<td><input name="OsVersion" type="text" size="27" tabindex="34" /></td>
			</tr>
			<tr>
				<th scope="row">画面横幅(WinWidth)</th>
				<td><input name="WinWidth" type="text" size="10" tabindex="35" class="num" /></td>
			</tr>
			<tr>
				<th scope="row">画面縦幅(WinHeight)</th>
				<td><input name="WinHeight" type="text" size="10" tabindex="36" class="num" /></td>
			</tr>
			<tr>
				<th scope="row">画面横方向dpi(Xdpi)</th>
				<td><input name="Xdpi" type="text" size="10" tabindex="37" class="num" /></td>
			</tr>
			<tr>
				<th scope="row">画面縦方向dpi(Ydpi)</th>
				<td><input name="Ydpi" type="text" size="10" tabindex="38" class="num" /></td>
			</tr>
