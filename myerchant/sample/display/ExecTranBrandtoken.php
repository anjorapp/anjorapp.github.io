...
<head>
	...
	<title>[ExecTranBrandtoken]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>ブランドトークン決済決済実行/モジュールタイプ(PHP) 呼び出しサンプル</h1>
...
<div id="main">
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				<th scope="row">トークン種別(TokenType)</th>
				<td><input name="TokenType" type="text" size="27" tabindex="16" /></td>
			</tr>
			<tr>
				<th scope="row">トークン(Token)</th>
				<td><input name="Token" type="text" size="27" tabindex="17" /></td>
			</tr>
			<tr>
				<th scope="row">サイトID(SiteID)</th>
				<td><input name="SiteID" type="text" size="27" tabindex="18" /></td>
			</tr>
			<tr>
				<th scope="row">サイトパスワード(SitePass)</th>
				<td><input name="SitePass" type="text" size="27" tabindex="19" /></td>
			</tr>
			<tr>
				<th scope="row">会員ID(MemberID)</th>
				<td><input name="MemberID" type="text" size="27" tabindex="20" /></td>
			</tr>
			<tr>
				<th scope="row">連番モード(SeqMode)</th>
				<td><input name="SeqMode" type="text" size="27" tabindex="21" /></td>
			</tr>
			<tr>
				<th scope="row">トークン連番(TokenSeq)</th>
				<td><input name="TokenSeq" type="text" size="10" tabindex="22" class="num" /></td>
			</tr>
			<tr>
				<th scope="row">加盟店向け自由項目1(ClientField1)</th>
				<td><input name="ClientField1" type="text" size="27" tabindex="23" /></td>
			</tr>
			<tr>
				<th scope="row">加盟店向け自由項目2(ClientField2)</th>
				<td><input name="ClientField2" type="text" size="27" tabindex="24" /></td>
			</tr>
			<tr>
				<th scope="row">加盟店向け自由項目3(ClientField3)</th>
				<td><input name="ClientField3" type="text" size="27" tabindex="25" /></td>
			</tr>
