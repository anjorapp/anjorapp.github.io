	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				...
				<td><input name="Token" type="text" size="27" tabindex="32" /></td>
			</tr>
			<tr>
				<th scope="row">サイトID(SiteID)</th>
				<td><input name="SiteID" type="text" size="27" tabindex="33" /></td>
			</tr>
			<tr>
				<th scope="row">サイトパスワード(SitePass)</th>
				<td><input name="SitePass" type="text" size="27" tabindex="34" /></td>
			</tr>
			<tr>
				<th scope="row">会員ID(MemberID)</th>
				<td><input name="MemberID" type="text" size="27" tabindex="35" /></td>
			</tr>
			<tr>
				<th scope="row">カード登録連番(CardSeq)</th>
				<td><input name="CardSeq" type="text" size="27" tabindex="36" /></td>
			</tr>
			<tr>
				<th scope="row">カード登録連番モード(SeqMode)</th>
				<td><input name="SeqMode" type="text" size="27" tabindex="37" /></td>
			</tr>
