...
<head>
	...
	<title>[ExecTranGANB]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>GANB決済実行/モジュールタイプ(PHP) 呼び出しサンプル</h1>
...
<div id="main">
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				<th scope="row">口座名義任意名(AccountHolderOptionalName)</th>
				<td><input name="AccountHolderOptionalName" type="text" size="27" tabindex="19" /></td>
			</tr>
			<tr>
				<th scope="row">取引有効日数(TradeDays)</th>
				<td><input name="TradeDays" type="text" size="10" tabindex="20" class="num" /></td>
			</tr>
			<tr>
				<th scope="row">取引事由(TradeReason)</th>
				<td><input name="TradeReason" type="text" size="27" tabindex="21" /></td>
			</tr>
			<tr>
				<th scope="row">振込依頼人氏名(TradeClientName)</th>
				<td><input name="TradeClientName" type="text" size="27" tabindex="22" /></td>
			</tr>
			<tr>
				<th scope="row">振込依頼人メールアドレス(TradeClientMailaddress)</th>
				<td><input name="TradeClientMailaddress" type="text" size="27" tabindex="23" /></td>
			</tr>
	...
	?>
		<table>
			...
			<tbody>
				...
				<tr>
					<th scope="row">預金種別(AccountType)</th>
				...
				<tr>
					<th scope="row">口座名義(AccountHolderName)</th>
					<td><?php echo htmlspecialchars( mb_convert_encoding( $output->getAccountHolderName() , PGCARD_SAMPLE_ENCODING , 'SJIS') ) ?></td>
				</tr>
				<tr>
					<th scope="row">取引有効期限(AvailableDate)</th>
