...
<head>
	...
	<title>[ExecTranMcp]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>多通貨クレジットカード決済実行/モジュールタイプ(PHP) 呼び出しサンプル</h1>
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				...
				<td><input name="Expire" type="text" size="27" tabindex="17" /></td>
			</tr>
			<tr>
				<th scope="row">セキュリティコード(SecurityCode)</th>
				<td><input name="SecurityCode" type="text" size="27" tabindex="18" /></td>
			</tr>
			<tr>
				<th scope="row">決済結果戻しURL(RetURL)</th>
				<td><input name="RetURL" type="text" size="27" tabindex="19" /></td>
			</tr>
			<tr>
				<th scope="row">処理NG時URL(ErrorRcvURL)</th>
				<td><input name="ErrorRcvURL" type="text" size="27" tabindex="20" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input name="PaymentTermSec" type="text" size="10" tabindex="25" class="num" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input name="CardSeq" type="text" size="27" tabindex="30" /></td>
			</tr>
			<tr>
				<th scope="row">カード登録連番モード(SeqMode)</th>
				<td><input name="SeqMode" type="text" size="27" tabindex="31" /></td>
			</tr>
