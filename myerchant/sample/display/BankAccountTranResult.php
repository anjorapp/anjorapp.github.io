...
<head>
	...
	<title>[BankAccountTranResult]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>口振オンライン口座振替申込トランザクション状態照会/モジュールタイプ(PHP) 呼び出しサンプル</h1>
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				...
				<td><input name="TranID" type="text" size="27" tabindex="13" /></td>
			</tr>
	...
	?>
		<table>
			...
			<tbody>
				...
				<tr>
					<th scope="row">登録結果(Status)</th>
					<td><?php echo $output->getStatus() ?></td>
				</tr>
				<tr>
					<th scope="row">金融機関コード(BankCode)</th>
				...
				<tr>
					<th scope="row">口座名義人カナ(AccountName)</th>
					<td><?php echo htmlspecialchars( mb_convert_encoding( $output->getAccountName() , PGCARD_SAMPLE_ENCODING , 'SJIS') ) ?></td>
				</tr>
				<tr>
					<th scope="row">本人確認済結果(AccountIdentification)</th>
					<td><?php echo $output->getAccountIdentification() ?></td>
				</tr>
