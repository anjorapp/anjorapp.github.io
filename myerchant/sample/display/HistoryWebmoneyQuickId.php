...
<head>
	...
	<title>[HistoryWebmoneyQuickId]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>WebmoneyクイックID利用明細URL取得/モジュールタイプ(PHP) 呼び出しサンプル</h1>
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				...
				<td><input name="QuickID" type="text" size="27" tabindex="13" /></td>
			</tr>
			<tr>
				<th scope="row">戻り先URL(ReturnUrl)</th>
				<td><input name="ReturnUrl" type="text" size="27" tabindex="14" /></td>
			</tr>
	...
	?>
		<table>
			...
			<tbody>
				...
				<tr>
					<th scope="row">利用明細画面URL(HistoryUrl)</th>
					<td><?php echo $output->getHistoryUrl() ?></td>
				</tr>
				<tr>
					<th scope="row">有効期限(ExpireDate)</th>
