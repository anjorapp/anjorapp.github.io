...
<head>
	...
	<title>[ExecTranWebmoneyQuick]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>Webmoneyクイック決済実行/モジュールタイプ(PHP) 呼び出しサンプル</h1>
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				...
				<td><input name="QuickID" type="text" size="27" tabindex="16" /></td>
			</tr>
			<tr>
				<th scope="row">商品・サービス名(ItemName)</th>
				<td><input name="ItemName" type="text" size="27" tabindex="17" /></td>
			</tr>
			<tr>
				<th scope="row">支払期限日数(PaymentTermDay)</th>
				<td><input name="PaymentTermDay" type="text" size="10" tabindex="18" class="num" /></td>
			</tr>
			<tr>
				<th scope="row">リダイレクトURL(RedirectURL)</th>
				<td><input name="RedirectURL" type="text" size="27" tabindex="19" /></td>
			</tr>
			<tr>
