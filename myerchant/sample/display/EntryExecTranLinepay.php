...
<div id="header">
	<h1>LINE Pay登録・決済実行/モジュールタイプ(PHP) 呼び出しサンプル</h1>
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				...
				<td><input name="SiteID" type="text" size="27" tabindex="19" /></td>
			</tr>
			<tr>
				<th scope="row">サイトパスワード(SitePass)</th>
				<td><input name="SitePass" type="text" size="27" tabindex="20" /></td>
			</tr>
			<tr>
				<th scope="row">会員ID(MemberID)</th>
				<td><input name="MemberID" type="text" size="27" tabindex="21" /></td>
			</tr>
			<tr>
				<th scope="row">会員名(MemberName)</th>
				<td><input name="MemberName" type="text" size="27" tabindex="22" /></td>
			</tr>
			<tr>
				<th scope="row">会員登録フラグ(CreateMember)</th>
				<td><input name="CreateMember" type="text" size="27" tabindex="23" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input name="RetURL" type="text" size="27" tabindex="28" /></td>
			</tr>
			<tr>
				<th scope="row">処理NG時URL(ErrorRcvURL)</th>
				<td><input name="ErrorRcvURL" type="text" size="27" tabindex="29" /></td>
			</tr>
			<tr>
				<th scope="row">商品画像URL(ProductImageUrl)</th>
				<td><input name="ProductImageUrl" type="text" size="27" tabindex="30" /></td>
			</tr>
			<tr>
				<th scope="row">LineメンバーID(Mid)</th>
				<td><input name="Mid" type="text" size="27" tabindex="31" /></td>
			</tr>
			<tr>
				<th scope="row">受取人連絡先(DeliveryPlacePhone)</th>
				<td><input name="DeliveryPlacePhone" type="text" size="27" tabindex="32" /></td>
			</tr>
			<tr>
				<th scope="row">決済待機画面用言語(LangCode)</th>
				<td><input name="LangCode" type="text" size="27" tabindex="33" /></td>
			</tr>
			<tr>
				<th scope="row">商品名(ProductName)</th>
				<td><input name="ProductName" type="text" size="27" tabindex="34" /></td>
			</tr>
			<tr>
				<th scope="row">phishing防止用情報(PackageName)(PackageName)</th>
				<td><input name="PackageName" type="text" size="27" tabindex="35" /></td>
			</tr>
			<tr>
				<th scope="row">端末情報(UserInfo)</th>
				<td><input name="UserInfo" type="text" size="27" tabindex="36" /></td>
			</tr>
			<tr>
				<th scope="row">戻り先URLスキーム(ReturnUrl)</th>
				<td><input name="ReturnUrl" type="text" size="27" tabindex="37" /></td>
			</tr>
