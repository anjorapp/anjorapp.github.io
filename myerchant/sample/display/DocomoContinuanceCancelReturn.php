...
<head>
	...
	<title>[DocomoContinuanceCancelReturn]-PGマルチペイメントサービス－モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>ドコモ継続決済決済取消/モジュールタイプ(PHP) 呼び出しサンプル</h1>
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				...
				<td><input name="CancelAmount" type="text" size="10" tabindex="11" class="num" /></td>
			</tr>
			<tr>
				<th scope="row">キャンセル税送料(CancelTax)</th>
				<td><input name="CancelTax" type="text" size="10" tabindex="11" class="num" /></td>
			</tr>
			<tr>
				<th scope="row">継続課金月(ContinuanceMonth)</th>
				<td><input name="ContinuanceMonth" type="text" size="10" tabindex="11" class="num" /></td>
			</tr>
			</tbody>
		</table>
	</form>
