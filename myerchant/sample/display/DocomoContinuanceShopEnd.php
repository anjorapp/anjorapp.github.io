...
<head>
	...
	<title>[DocomoContinuanceShopEnd]-PGマルチペイメントサービス－モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>ドコモ継続決済継続課金終了(加盟店)/モジュールタイプ(PHP) 呼び出しサンプル</h1>
...
<div id="main">
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				<th scope="row">退会月利用料無料区分</th>
				<td><input name="LastMonthFreeFlag" type="text" size="27" tabindex="11" /></td>
			</tr>
			</tbody>
		</table>
	</form>
