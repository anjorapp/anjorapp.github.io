...
<head>
	...
	<title>[CheckPaidBuyer]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>Paid取引先ステータス確認/モジュールタイプ(PHP) 呼び出しサンプル</h1>
	...
	?>
		<table>
			...
			<tbody>
				...
				<tr>
					<th scope="row">審査状態(BuyerStatus)</th>
					<td><?php echo $output->getBuyerStatus() ?></td>
				</tr>
