...
<div id="header">
	<h1>Paid登録・決済実行/モジュールタイプ(PHP) 呼び出しサンプル</h1>
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				...
				<td><input name="PaidBuyerID" type="text" size="27" tabindex="18" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input name="Contents" type="text" size="27" tabindex="23" /></td>
			</tr>
