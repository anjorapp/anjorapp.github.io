...
<head>
	...
	<title>[ExecTranDocomoAccept]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>ドコモ払い_随時決済決済実行/モジュールタイプ(PHP) 呼び出しサンプル</h1>
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				...
				<td><input name="DocomoDisp1" type="text" size="27" tabindex="19" /></td>
			</tr>
			<tr>
				<th scope="row">ドコモ表示項目2(DocomoDisp2)</th>
				<td><input name="DocomoDisp2" type="text" size="27" tabindex="20" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input name="DispShopName" type="text" size="27" tabindex="23" /></td>
			</tr>
			<tr>
				<th scope="row">連絡先電話番号(DispPhoneNumber)</th>
				<td><input name="DispPhoneNumber" type="text" size="27" tabindex="24" /></td>
			</tr>
			<tr>
				<th scope="row">メールアドレス(DispMailAddress)</th>
				<td><input name="DispMailAddress" type="text" size="27" tabindex="25" /></td>
			</tr>
			<tr>
				<th scope="row">問合せURL(DispShopUrl)</th>
				<td><input name="DispShopUrl" type="text" size="27" tabindex="26" /></td>
			</tr>
