...
<head>
	...
	<title>[AuAcceptUserEnd]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>auかんたん決済支払い（利用承諾）利用承諾終了/モジュールタイプ(PHP) 呼び出しサンプル</h1>
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				...
				<td><input name="AuAcceptCode" type="text" size="27" tabindex="16" /></td>
			</tr>
