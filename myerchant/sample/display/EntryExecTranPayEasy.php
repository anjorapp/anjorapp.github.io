...
<div id="header">
	<h1>PayEasy取引登録・決済実行/モジュールタイプ(PHP) 呼び出しサンプル</h1>
		...
		<table>
			<tbody>
				<tr>
					...
					<td><input name="OrderID" type="text" maxlength="27" size="27" tabindex="9" /></td>
				</tr>
				<tr>
					<th scope="row">利用金額(Amount)</th>
					<td><input name="Amount" type="text" maxlength="8" size="10" tabindex="10" class="num" /></td>
				</tr>
				<tr>
					<th scope="row">税送料(Tax)</th>
					<td><input name="Tax" type="text" maxlength="7" size="10" tabindex="11" class="num" /></td>
				</tr>
				<tr>
					<th scope="row">加盟店自由項目１(ClientField1)</th>
					<td><input name="ClientField1" type="text" maxlength="100" tabindex="12" /> </td>
				</tr>
				<tr>
					<th scope="row">加盟店自由項目２(ClientField2)</th>
					<td><input name="ClientField2" type="text" maxlength="100" tabindex="13" /> </td>
				</tr>
				<tr>
					<th scope="row">加盟店自由項目３(ClientField3)</th>
					<td><input name="ClientField3" type="text" maxlength="100" tabindex="14" /> </td>
				</tr>
			</tbody>
		</table>
		<table>
			<tbody>
				...
				<tr>
					...
					<td><input name="ReceiptsDisp11" type="text" maxlength="60" class="text" tabindex="42" /></td>
				</tr>
				<tr>
					<th scope="row">お問合せ先電話番号</th>
					<td><input name="ReceiptsDisp12" type="text" maxlength="60" class="text" tabindex="43" /></td>
				</tr>
				<tr>
					<th scope="row">お問合せ先受付時間</th>
					<td><input name="ReceiptsDisp13" type="text" maxlength="60" class="text" tabindex="44" /></td>
				</tr>
				<tr>
					<th scope="row">決済タイプ</th>
					<td><input name="PaymentType" type="text" maxlength="60" class="text" tabindex="45" /></td>
				</tr>
			</tbody>
		</table>
