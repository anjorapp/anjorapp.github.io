...
<div id="header">
	<h1>auかんたん決済取引登録/モジュールタイプ(PHP) 呼び出しサンプル</h1>
	...
	?>
		<table>
			...
			<tfoot>
				<tr>
					<td colspan="2">
						<a href="ExecTranAu.php?<?php echo 'AccessID=' . urlencode( $output->getAccessID()) . '&AccessPass=' . urlencode( $output->getAccessPass())  ?>" tabindex="30">
						引き続き決済実行(ExecTranAu)を行う</a>
					</td>
				</tr>
			</tfoot>
