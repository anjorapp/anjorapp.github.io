...
<head>
	...
	<title>[MaillinkRegiststart]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>メールリンクカード登録/モジュールタイプ(PHP) 呼び出しサンプル</h1>
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				...
				<td><input name="MemberID" type="text" size="27" tabindex="15" /></td>
			</tr>
			<tr>
				<th scope="row">会員名(MemberName)</th>
				<td><input name="MemberName" type="text" size="27" tabindex="16" /></td>
			</tr>
			<tr>
				<th scope="row">メールリンク注文番号(MailLinkOrderNo)</th>
				<td><input name="MailLinkOrderNo" type="text" size="27" tabindex="17" /></td>
			</tr>
			<tr>
				<th scope="row">メールアドレス(MailAddress)</th>
				<td><input name="MailAddress" type="text" size="27" tabindex="18" /></td>
			</tr>
			<tr>
				<th scope="row">メッセージ言語(Lang)</th>
				<td><input name="Lang" type="text" size="27" tabindex="19" /></td>
			</tr>
			<tr>
				<th scope="row">テンプレートNo.(TemplateNo)</th>
				<td><input name="TemplateNo" type="text" size="10" tabindex="20" class="num" /></td>
			</tr>
			<tr>
				<th scope="row">有効日数(ExpireDays)</th>
				<td><input name="ExpireDays" type="text" size="10" tabindex="21" class="num" /></td>
			</tr>
