...
<head>
	...
	<title>[ExecTranPaid]-PGマルチペイメントサービス−モジュールタイプ呼び出しサンプル</title>
</head>
<body>

<div id="header">
	<h1>Paid決済実行/モジュールタイプ(PHP) 呼び出しサンプル</h1>
	...
	<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post">
		<table>
			...
			<tr>
				...
				<td><input name="PaidBuyerID" type="text" size="27" tabindex="16" /></td>
			</tr>
			<tr>
			...
			<tr>
				<th scope="row">注文内容(Contents)</th>
				<td><input name="Contents" type="text" size="27" tabindex="21" /></td>
			</tr>
