...
if( isset( $_POST['submit'] ) ){
	require_once( 'com/gmo_pg/client/input/DeletePrecaInput.php');
	require_once( 'com/gmo_pg/client/tran/DeletePreca.php');

	//入力パラメータクラスをインスタンス化します
	$input = new DeletePrecaInput();/* @var $input DeletePrecaInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new DeletePreca();/* @var $exec DeletePreca */

	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output DeletePrecaOutput */
...
//DeletePreca入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/DeletePreca.php' );