...
if( isset($_POST['submit'])) {
	...
	$input = new ExecTranWebmoneyInput();
	...
	$input->setShopMailAddress( $_POST['ShopMailAddress'] );
...
require_once( PGCARD_SAMPLE_BASE . '/display/ExecTranWebmoney.php' );
