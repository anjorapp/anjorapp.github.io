...
if( isset( $_POST['submit'] ) ){
	...
	$input = new ExecTranSbInput();/* @var $input ExecTranSbInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new ExecTranSb();/* @var $exec ExecTranSb */

	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output ExecTranSbOutput */
...
//ExecTranSb入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/ExecTranSb.php' );