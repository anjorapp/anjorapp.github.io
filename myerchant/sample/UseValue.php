...
if( isset( $_POST['submit'] ) ){
	require_once( 'com/gmo_pg/client/input/UseValueInput.php');
	require_once( 'com/gmo_pg/client/tran/UseValue.php');

	//入力パラメータクラスをインスタンス化します
	$input = new UseValueInput();/* @var $input UseValueInput */
...
//UseValue入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/UseValue.php' );