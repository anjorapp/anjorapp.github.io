...
if( isset( $_POST['submit'] ) ){
	...
	$input = new EntryTranVirtualaccountInput();/* @var $input EntryTranVirtualaccountInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new EntryTranVirtualaccount();/* @var $exec EntryTranVirtualaccount */

	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output EntryTranVirtualaccountOutput */
...
//EntryTranVirtualaccount入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/EntryTranVirtualaccount.php' );