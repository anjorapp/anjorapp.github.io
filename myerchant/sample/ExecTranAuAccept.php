...
if( isset( $_POST['submit'] ) ){
	...
	$input = new ExecTranAuAcceptInput();/* @var $input ExecTranAuAcceptInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new ExecTranAuAccept();/* @var $exec ExecTranAuAccept */

	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output ExecTranAuAcceptOutput */
...
//ExecTranAuAccept入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/ExecTranAuAccept.php' );