...
if( isset( $_POST['submit'] ) ){
	...
	$input = new EntryTranSuicaInput();/* @var $input EntryTranSuicaInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new EntryTranSuica();/* @var $exec EntryTranSuica */
...
//EntryTranSuica入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/EntryTranSuica.php' );