...
if( isset( $_POST['submit'] ) ){
	require_once( 'com/gmo_pg/client/input/PaidReturnInput.php');
	require_once( 'com/gmo_pg/client/tran/PaidReturn.php');

	//入力パラメータクラスをインスタンス化します
	$input = new PaidReturnInput();/* @var $input PaidReturnInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new PaidReturn();/* @var $exec PaidReturn */

	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output PaidReturnOutput */
...
//PaidReturn入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/PaidReturn.php' );