...
if( isset( $_POST['submit'] ) ){
	require_once( 'com/gmo_pg/client/input/PaidChangeInput.php');
	require_once( 'com/gmo_pg/client/tran/PaidChange.php');

	//入力パラメータクラスをインスタンス化します
	$input = new PaidChangeInput();/* @var $input PaidChangeInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new PaidChange();/* @var $exec PaidChange */

	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output PaidChangeOutput */
...
//PaidChange入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/PaidChange.php' );