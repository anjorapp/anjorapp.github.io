...
if( isset( $_POST['submit'] ) ){
	...
	$input = new ExecTranRecruitContinuanceInput();/* @var $input ExecTranRecruitContinuanceInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new ExecTranRecruitContinuance();/* @var $exec ExecTranRecruitContinuance */

	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output ExecTranRecruitContinuanceOutput */
...
//ExecTranRecruitContinuance入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/ExecTranRecruitContinuance.php' );