...
if( isset( $_POST['submit'] ) ){
	require_once( 'com/gmo_pg/client/input/PaidCancelInput.php');
	require_once( 'com/gmo_pg/client/tran/PaidCancel.php');

	//入力パラメータクラスをインスタンス化します
	$input = new PaidCancelInput();/* @var $input PaidCancelInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new PaidCancel();/* @var $exec PaidCancel */

	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output PaidCancelOutput */
...
//PaidCancel入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/PaidCancel.php' );