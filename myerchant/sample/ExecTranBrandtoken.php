...
if( isset( $_POST['submit'] ) ){
	...
	$input = new ExecTranBrandtokenInput();/* @var $input ExecTranBrandtokenInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new ExecTranBrandtoken();/* @var $exec ExecTranBrandtoken */

	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output ExecTranBrandtokenOutput */
...
//ExecTranBrandtoken入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/ExecTranBrandtoken.php' );