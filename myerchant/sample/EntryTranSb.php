...
if( isset( $_POST['submit'] ) ){
	...
	$input = new EntryTranSbInput();/* @var $input EntryTranSbInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new EntryTranSb();/* @var $exec EntryTranSb */

	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output EntryTranSbOutput */
...
//EntryTranSb入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/EntryTranSb.php' );