...
if( isset( $_POST['submit'] ) ){
	require_once( 'com/gmo_pg/client/input/PayCancelInput.php');
	require_once( 'com/gmo_pg/client/tran/PayCancel.php');

	//入力パラメータクラスをインスタンス化します
	$input = new PayCancelInput();/* @var $input PayCancelInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new PayCancel();/* @var $exec PayCancel */

	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output PayCancelOutput */
...
//PayCancel入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/PayCancel.php' );