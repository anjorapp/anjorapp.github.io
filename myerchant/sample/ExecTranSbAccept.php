...
if( isset( $_POST['submit'] ) ){
	...
	$input = new ExecTranSbAcceptInput();/* @var $input ExecTranSbAcceptInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new ExecTranSbAccept();/* @var $exec ExecTranSbAccept */

	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output ExecTranSbAcceptOutput */
...
//ExecTranSbAccept入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/ExecTranSbAccept.php' );