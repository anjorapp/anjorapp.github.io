...
if( isset( $_POST['submit'] ) ){
	...
	$input = new ExecTranBankaccountInput();/* @var $input ExecTranBankaccountInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new ExecTranBankaccount();/* @var $exec ExecTranBankaccount */

	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output ExecTranBankaccountOutput */
...
//ExecTranBankaccount入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/ExecTranBankaccount.php' );