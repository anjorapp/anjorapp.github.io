...
if( isset( $_POST['submit'] ) ){
	require_once( 'com/gmo_pg/client/input/PaidSalesInput.php');
	require_once( 'com/gmo_pg/client/tran/PaidSales.php');

	//入力パラメータクラスをインスタンス化します
	$input = new PaidSalesInput();/* @var $input PaidSalesInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new PaidSales();/* @var $exec PaidSales */

	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output PaidSalesOutput */
...
//PaidSales入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/PaidSales.php' );