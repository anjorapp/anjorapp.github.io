...
if( isset( $_POST['submit'] ) ){
	...
	$input = new ExecTranDocomoAcceptInput();/* @var $input ExecTranDocomoAcceptInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new ExecTranDocomoAccept();/* @var $exec ExecTranDocomoAccept */

	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output ExecTranDocomoAcceptOutput */
...
//ExecTranDocomoAccept入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/ExecTranDocomoAccept.php' );