...
if( isset( $_POST['submit'] ) ){
	...
	$input = new EntryTranAuAcceptInput();/* @var $input EntryTranAuAcceptInput */
	...
	//API通信クラスをインスタンス化します
	$exe = new EntryTranAuAccept();/* @var $exec EntryTranAuAccept */

	//パラメータオブジェクトを引数に、実行メソッドを呼び、結果を受け取ります。
	$output = $exe->exec( $input );/* @var $output EntryTranAuAcceptOutput */
...
//EntryTranAuAccept入力・結果画面
require_once( PGCARD_SAMPLE_BASE . '/display/EntryTranAuAccept.php' );