...
if( isset( $_POST['submit'] ) ){
	...
	$input->setSubscriptionType($_POST['SubscriptionType']);
	$input->setSubscriptionName( mb_convert_encoding( $_POST['SubscriptionName'] , 'SJIS' , PGCARD_SAMPLE_ENCODING ) );
	$input->setSettlementSubscriptionId($_POST['SettlementSubscriptionId']);
