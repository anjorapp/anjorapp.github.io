...
export default function Home() {
  return (
    <>
      <div className="hero-banner relative w-full h-svh flex items-center justify-center">
        <div id="pt" className="canvas -z-0"></div>
        <div className="z-10 flex flex-col items-center justify-center">
          <span className="font-mono text-sm text-primary">// portfolio v2.0</span>
          <h1 className="text-7xl md:text-9xl font-bold font-display text-primary-bright">
            Anjorapp
          </h1>
          <p className="text-center text-2xl md:text-2xl font-bold font-display tracking-widest text-muted">
            Anjo Ralph Mingo <br />
            Full-Stack Web Developer
          </p>
          <div className="flex gap-6 mt-8 font-display tracking-widest">
            <a href="#work"
